    ...
    return (
        ...
        <div ref={targetRef} className="footer-container">
            <div className="footer-headings">
                ...
                <div>
                    <span>Develop your future with<span style={{ color: "#F0A202" }}>{"\u00A0Us!!"}</span> </span>
                    
                </div>
                <a href='https://chat.whatsapp.com/K6LHYjNEuxg0gyKBdqMUaf' target="_blank" rel="noreferrer"><div className="footer-whatsapp" onClick={()=>window.fbq('track', ' AddtoWhatsapp')}>
